			...
			(function() {
				...
				// Wheel event.
					$body.on('wheel', function(event) {
						...
						// Prevent default.
							// When this occur error: [Intervention] Unable to preventDefault inside passive event listener due to target being treated as passive. See https://www.chromestatus.com/features/6662647093133312
							// event.preventDefault();
